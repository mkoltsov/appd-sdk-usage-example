 ...
 */
public class TCPServerIntermediaryThreadEnd extends AGenericInterceptor {
    //rx.subjects.AsyncSubject

    private static final String CLASS_TO_INSTRUMENT = "com.appdynamics.selab.tcpserver.TCPServer$Intermediary";
    private static final String METHOD_TO_INSTRUMENT = "processQueue";

    public TCPServerIntermediaryThreadEnd(){
        super();
    }
