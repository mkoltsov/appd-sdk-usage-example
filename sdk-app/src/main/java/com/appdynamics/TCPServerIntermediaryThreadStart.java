 ...
 */
public class TCPServerIntermediaryThreadStart extends AGenericInterceptor {
    //rx.subjects.AsyncSubject

    private static final String CLASS_TO_INSTRUMENT = "com.appdynamics.selab.util.Pipeline";
    private static final String METHOD_TO_INSTRUMENT = "put";

    public TCPServerIntermediaryThreadStart(){
        super();
    }
